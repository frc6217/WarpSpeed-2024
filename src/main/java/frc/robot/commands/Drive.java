...
public class Drive extends Command {
  ...
  public void execute() {
    ...
    swerveDrivetrain.drive(new Translation2d(getTranslation(), getStrafe()).times(governor*Constants.RobotConstants.driveMaxVelo), getRotation()*(Constants.RobotConstants.rotationMaxAngleVelo*governor*.7));
